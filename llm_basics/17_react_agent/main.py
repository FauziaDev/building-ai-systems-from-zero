...
def run_agent(question):
    ...
    for step in range(5):
        ...
        if match:
            ...
            # Give tool result back to LLM .  Ye poora part ReAct Agent hai. ✅
            messages.append({
                "role": "user",
                "content":
                    "Observation: "
...
prompt1 = "What is the price of iPhone 17?"
...
I have 5000 rupees.
Based on the previous result, calculate how much money I will have left.
"""
